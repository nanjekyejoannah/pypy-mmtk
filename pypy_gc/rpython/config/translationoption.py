...
translation_optiondescription = OptionDescription(
    ...
    ChoiceOption("gc", "Garbage Collection Strategy",
                 ["boehm", "ref", "semispace","mmtksemispace", "statistics",
                  "generation", "hybrid", "minimark","mmtkminimark",'incminimark', "none"],
                  "ref", requires={
                     ...
                     "mmtksemispace": [("translation.gctransformer", "framework")],
                     ...
                     "mmtkminimark": [("translation.gctransformer", "framework")],
