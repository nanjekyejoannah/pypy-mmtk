#ifndef MMTK_PYPY_MMTK_H
#define MMTK_PYPY_MMTK_H
...
//  * Allocation
//  */
extern MMTk_Mutator bind_mutator();
...
// extern Address alloc(MMTk_Mutator mutator, size_t size,
//     size_t align, size_t offset);

// extern void *alloc(size_t size, size_t align, size_t offset);
extern void* alloc(void * mutator,
                        size_t size,
                        size_t align,
                        ssize_t offset);
extern void mmtk_post_alloc(void* mutator, void* refer,
    int bytes);
...
// /// Full pre-barrier
extern void mmtk_object_reference_write_pre(void* mutator, void* src, void* slot, void* target);
...
extern void pypy_gc_init();
extern bool pypy_is_gc_initialized();
...
// // PZ: It shouldn't be ...?
// extern size_t pypy_max_capacity();
